...
func TestExamplesComplete(t *testing.T) {
	...
	terraformOptions := &terraform.Options{
		...
		// Use the consumer stack as the target so we can access its outputs TerraformDir: "../../examples/complete/consumer",
		TerraformDir: "../../examples/complete/consumer",
		Upgrade:      true,
		...
		EnvVars: map[string]string{
			...
			// Since we are specifying the consumer stack as the terragrunt dir,
